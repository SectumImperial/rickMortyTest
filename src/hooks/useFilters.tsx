...
interface FilterActions {
  setFilter: (payload: { filterName: string; value: string }) => { type: string; payload: unknown };
...
const filterActions: Record<FilterType, FilterActions> = {
  characters: {
    ...
    resetFilters: resetCharacterFilters as unknown as FilterActions['resetFilters'],
  },
  locations: {
    setFilter: setLocationsFilter as unknown as FilterActions['setFilter'],
    resetFilters: resetLocationsFilters as unknown as FilterActions['resetFilters'],
  },
  episodes: {
    setFilter: setEpisodeFilter as unknown as FilterActions['setFilter'],
    resetFilters: resetEpisodeFilters as unknown as FilterActions['resetFilters'],
  },
}
...
export const useFilters = (type: FilterType): UseFiltersReturnType => {
  ...
  const getCurrentFilters = (): Record<string, string> => {
    return JSON.parse(localStorage.getItem(`${type}Filters`) || '{}') as Record<string, string>;
  };
